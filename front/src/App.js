...
import MyPagesSeconStudy from "./admin/myPages/SecondStudy";
...
import SecondStudyWorker from "./admin/Akobir/SecondStudy";
// app admin
...
import ManagerSecondStudy from "./admin/admin_manager/SecondStudy";
// agent
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path={"/dashboard/SecondStudy"} element={<MyPagesSeconStudy />} />
        ...
        <Route path={"/manager/SecondStudy"} element={<ManagerSecondStudy />} />
